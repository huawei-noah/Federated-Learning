...
from flsuite.data.datasets.office_home import augmentation, transform, weak_augmentation
...
def experiment(args):
    ...
    path = f"./data/experiments/domain_generalization/OfficeHome/{path_augment}/{args.trainer}/"
    ...
    train_loaders = data.build_dataloaders(
        train_sets, batch_size, pin_memory=args.pin_memory, num_workers=args.workers
    )
    ...
    global_model = flsuite.models.model_loader(
        "OfficeHome",
        1,
        seed=args.seed,
